...
-- AZ Nature ────────────────────────────────────────────────────
  ...
  INSERT INTO users (nom, email, password, rizerie, rizerie_id, role)
    VALUES (v_manager, v_email, crypt(v_email, gen_salt('bf',12)), v_nom, v_id, 'rizier')
...
-- ──────────────────────────────────────────────────────────────
  ...
  INSERT INTO users (nom, email, password, role)
    VALUES ('Caroline Bamba', v_email, crypt(v_email, gen_salt('bf',12)), 'support')
    ON CONFLICT (email) DO NOTHING;

  v_email := 'frank@partnersinfoodsolutions.com';
  INSERT INTO users (nom, email, password, role)
    VALUES ('Frank Bentum', v_email, crypt(v_email, gen_salt('bf',12)), 'support')
    ON CONFLICT (email) DO NOTHING;

  v_email := 'gloriab@partnersinfoodsolutions.com';
  INSERT INTO users (nom, email, password, role)
    VALUES ('Gloria Buah-Kwofie', v_email, crypt(v_email, gen_salt('bf',12)), 'support')
    ON CONFLICT (email) DO NOTHING;

  v_email := 'ibrahima@partnersinfoodsolutions.com';
  INSERT INTO users (nom, email, password, role)
    VALUES ('Ibrahima Sory Diallo', v_email, crypt(v_email, gen_salt('bf',12)), 'support')
    ON CONFLICT (email) DO NOTHING;

  v_email := 'ndeye@partnersinfoodsolutions.com';
  INSERT INTO users (nom, email, password, role)
    VALUES ('Ndeye Marie Ngom', v_email, crypt(v_email, gen_salt('bf',12)), 'support')
    ON CONFLICT (email) DO NOTHING;

  v_email := 'fabiennes@partnersinfoodsolutions.com';
  INSERT INTO users (nom, email, password, role)
    VALUES ('Fabienne Secka Koffi', v_email, crypt(v_email, gen_salt('bf',12)), 'support')
    ON CONFLICT (email) DO NOTHING;

  v_email := 'fabienne@partnersinfoodsolutions.com';
  INSERT INTO users (nom, email, password, role)
    VALUES ('Fabienne Vuanda', v_email, crypt(v_email, gen_salt('bf',12)), 'support')
    ON CONFLICT (email) DO NOTHING;
